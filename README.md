...
API для проекта **YaMDb**, предназначенный для сбора отзывов на произведения.

## Описание

Проект YaMDb агрегирует отзывы пользователей на фильмы, книги, музыку и другие произведения, позволяя пользователям оставлять оценки и комментарии.
