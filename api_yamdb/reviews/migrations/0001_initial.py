# Generated by Django 3.2 on 2024-11-05 14:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(db_index=True, max_length=256, verbose_name='Название')),
                ('year', models.IntegerField(db_index=True, validators=[django.core.validators.MinValueValidator(0, 'Значение не может быть меньше 0'), django.core.validators.MaxValueValidator(2024, message='Значение не может быть больше 2024')], verbose_name='Год')),
